...
import imagen1 from '../public/logo.svg';
import imagen2 from '../public/perfil.svg';
              ...
              <div className="flex items-center justify-between h-16">
                <div className="flex items-center">
                  <div className="flex-shrink-0">
                    <Image className="h-8 w-8" src={imagen1} alt="Workflow" />
                  </div>
                    ...
                    <Menu as="div" className="ml-3 relative">
                      <div>
                        <Menu.Button className="max-w-xs bg-gray-800 rounded-full flex items-center text-sm focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                          ...
                          <Image className="h-8 w-8 rounded-full" src={imagen2} alt="" width={35} height={35} />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
            ...
            <Disclosure.Panel className="md:hidden">
              ...
              <div className="pt-4 pb-3 border-t border-gray-700">
                <div className="flex items-center px-5">
                  <div className="flex-shrink-0">
                    <Image className="h-10 w-10 rounded-full" src={imagen2} alt="" />
                  </div>
                  <div className="ml-3">
